...
export default function Header() {
  ...
  const getCurrentPageLink = () => {
    ...
    // Define your conditions and return the appropriate link
    if (currentPath === '/') {
      return '/arabic-home';
    } else if (currentPath === '/arabic-home') {
      return '/';
    } else if (currentPath === '/contact') {
      return '/arabic-contact';
    } else if (currentPath === '/arabic-contact') {
      return '/contact';
    } else if (currentPath === '/shop') {
      return '/arabic-shop';
    } else if (currentPath === '/arabic-shop') {
      return '/shop';
    } else if (currentPath === '/faq') {
      return '/arabic-faq';
    } else if (currentPath === '/arabic-faq') {
      return '/faq';
    }else if (currentPath === '/quiz') {
      return '/arabic-quiz';
    } else if (currentPath === '/arabic-quiz') {
      return '/quiz';
    }

    // Default case (no change in link)
    return currentPath;
  };
