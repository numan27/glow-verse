...
import AppLayoutArabic from '../../../components/AppLayoutArabic/AppLayoutArabic';
import { Button } from '@material-tailwind/react';
import IMAGES from '../../../assets/images';
import QuestionOptions from './QuestionsArabic';
    ...
    if (currentStep.type === 'input') {
      ...
      if (currentStep.label === 'Email') {
        if (!isValidEmail(value)) {
          setEmailError('يرجى إدخال البريد الإلكتروني الصحيح');
          return;
        } else {
          setEmailError('');
        }
